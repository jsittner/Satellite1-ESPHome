...
static tv last_server_time;
static tv last_reported_time_delta;

static tv get_est_server_time()
{
    const tv now = tv::now();
...
void SnapcastStream::on_time_msg(MessageHeader msg, tv latency_c2s){
    ...
    tv latency_s2c = tv::now() - msg.sent;
            ...
            case message_type::kWireChunk:
                {
                    ...
                    timed_chunk->stamp.sec = wire_chunk_msg.timestamp_sec;
                    timed_chunk->stamp.usec = wire_chunk_msg.timestamp_usec;
